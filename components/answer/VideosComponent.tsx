...
return (
    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 mt-4 w-full">
        ...
        <div className="flex items-center">
            ...
            <img src="https://media.licdn.com/dms/image/D4E0BAQFrogZyB54lIA/company-logo_200_200/0/1664300453554?e=1721260800&v=beta&t=pabFOugpnbExpOr9TqLwdNzw6vKdlZwgxsaWDa1bR_o" alt="mkt intent logo" className="w-6 h-6" />
        </div>
